...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#262525] text-white p-4 w-24 hover:w-52 transition-all duration-300 fixed h-screen z-[10]">
      <div className="container mx-auto flex items-center flex flex-col h-full">
        <img src={Logo} alt="Logo Carspot" className="w-20"/>
